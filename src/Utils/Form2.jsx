      ...
      <div className="ml-2 mt-9">
        ...
        <div className="form-container">
          <form className="grid  grid-cols gap-6">
            <div className="grid md:grid-cols-2 gap-2 grid-rows-1">
            ...
            <div className="grid md:grid-cols-2 gap-2 grid-rows-1">
              <label htmlFor="father-name">
                <h4 className="form-label">Father's Name</h4>
                <input
                  id="father-name"
                  type="type"
              ...
              <label htmlFor="mother-name">
                <h4 className="form-label">Mother's Name</h4>
                <input
                  id="mother-name"
                  type="type"
            ...
            <div className="grid md:grid-cols-3 sm:grid-cols-2 gap-2 grid-rows-1">
            ...
            <div className="grid md:grid-cols-3 gap-1 grid-rows-1">
              <label htmlFor="dist">
            ...
            <div className="grid md:grid-cols-3 gap-6 grid-rows-1">
              ...
              <label htmlFor="father-phone-no">
                <h4 className="form-label">Father's Phone No</h4>
                <input
                  id="father-phone-no"
                  type="type"
                  placeholder="+91"
